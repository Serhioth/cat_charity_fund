...
Revision ID: 574c25264018
Revises: 
Create Date: 2024-03-06 16:10:39.809576
...
def upgrade():
    ...
    sa.CheckConstraint('full_amount > 0', name='check_full_amount_is_positive'),
